...
class CustomInstallCommand(install):
    def run(self):
        ...
        # Path to the target directory generated by Rust build
        target_dir = os.path.join(self.install_lib, 'spannerflow', 'target')

        # Check if the target directory exists and copy it
        if os.path.isdir('spannerflow/target'):
            # Copy the target directory to the installation directory
            shutil.copytree('spannerflow/target', target_dir)
