...
class IEFunctionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.RunIEFunction = channel.unary_stream(
...
class IEFunctionServiceServicer(object):
    ...
    def RunIEFunction(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_IEFunctionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RunIEFunction': grpc.unary_stream_rpc_method_handler(
